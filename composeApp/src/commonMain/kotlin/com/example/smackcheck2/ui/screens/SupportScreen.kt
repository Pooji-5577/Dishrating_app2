...
fun SupportScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Support", color = DeepMaroon, fontSize = 18.sp, fontWeight = FontWeight.Bold) },
                navigationIcon = {
...
private fun SupportMenuItem(
    ...
    Row(
        ...
        Text(title, color = DeepMaroon, fontSize = 15.sp, fontWeight = FontWeight.Medium, modifier = Modifier.weight(1f))
