...
data class RestaurantDetailUiState(
    ...
    val hasDishes: Boolean get() = dishes.isNotEmpty()
    val shouldShowRatings: Boolean get() = hasDishes
}
...
data class DishCaptureUiState(
    ...
    val showNotFoodError: Boolean = false
) {
    override fun equals(other: Any?): Boolean {
        ...
        if (showNotFoodError != other.showNotFoodError) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + showNotFoodError.hashCode()
        return result
    }
}
